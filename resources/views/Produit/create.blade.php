...
<div class="container my-5">
    <div class="content-wrapper">
        <div class="mb-4">
            ...
            <p class="text-muted mb-0">Complétez le formulaire pour créer un nouveau produit</p>
        </div>
        ...
        <form action="{{ route('produit.store') }}" method="POST">
            ...
            <!-- Produit.create.blade.php -->

<div class="col-md-6">
    <label class="form-label fw-bold">
        <i class="fas fa-list me-2 text-primary"></i> Catégorie *
    </label>
