    ...
    <div class="container py-5">
        ...
        <div class="mb-4 text-center">
            ...
            <p class="activities-subtitle" data-aos="fade-up">
                Mettez à jour les informations du produit "<strong>{{ $produit->nom }}</strong>"
            </p>
        </div>
        ...
        <!-- Formulaire -->
        <form action="{{ route('produit.update', $produit->id) }}" method="POST" data-aos="fade-up">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nom" class="form-control input-dashboard @error('nom') is-invalid @enderror"
                        value="{{ old('nom', $produit->nom) }}" placeholder="Ex: Café au lait" required>
                    @error('nom')
